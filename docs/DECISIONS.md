...
| 2026-06-14 | **Mobile voice: test Web Speech free first (on the S25)** before paying for Deepgram. Voice-in behind an adapter so swapping is config, not a rebuild. | Fluid speech is the top priority; test before paying. |
